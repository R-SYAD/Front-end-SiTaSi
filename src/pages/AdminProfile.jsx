  ...
  const fetchProfileData = async () => {
    try {
      ...
      const profileresponse = await fetch(
        "http://localhost:3000/profiladmin",
        {
          method: "GET",
          headers: {
      ...
      setProfilAdmin(userData.profil);
      setName(userData.profil.nama_admin);
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch(
        "http://localhost:3000/editprofiladmin",
        requestOptions
      );
                    ...
                    <Form id="profile">
                      ...
                      >
                        ...
                        <Col sm={8}>
                          <Form.Control
                            type="text"
                            placeholder={profilAdmin.nama_admin}
                            value={name}
                      ...
                      >
                        ...
                        <Col sm={8}>
                          <Form.Control
                            type="text"
                            placeholder={profilAdmin.jenis_kelamin}
                            value={jenisKelamin}
