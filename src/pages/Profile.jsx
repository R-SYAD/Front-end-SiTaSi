...
const Profile = () => {
  ...
  const [profilMahasiswa, setProfilMahasiswa] = useState("");
  ...
  const fetchProfileData = async () => {
    try {
      ...
      setProfilMahasiswa(userData.profil);
      setName(userData.profil.nama_mahasiswa);
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch(
        "http://localhost:3000/editprofilmahasiswa",
        requestOptions
      );
                    ...
                    <Form id="profile">
                      ...
                      >
                        ...
                        <Col sm={8}>
                          <Form.Control
                            type="text"
                            placeholder={profilMahasiswa.nama_mahasiswa}
                            value={name}
                      ...
                      >
                        ...
                        <Col sm={8}>
                          <Form.Control
                            type="text"
                            placeholder={profilMahasiswa.jenis_kelamin}
                            value={jenisKelamin}
